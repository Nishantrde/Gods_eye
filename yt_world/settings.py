"""
Django settings for yt_world project.
...
SECRET_KEY = 'django-insecure-1=caa!lf@8t%!85+0)zg3(grf5xf4y*^fidm2cwwyqk0fow8#*'
...
WSGI_APPLICATION = 'yt_world.wsgi.application'
